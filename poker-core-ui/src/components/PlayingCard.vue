...
<template>
    <v-sheet border rounded="lg" class="playing-card" color="grey-lighten-3" height="350" width="250" @click="clickIt">
        ...
        <span class="card-symbol card-symbol_middle" :class="`card-symbol_${suitColor} card-symbol_${localSuit}`">
        </span>
    </v-sheet>
</template>
